...
extension OpenRouterChatCompletionRequestBody {
    ...
    nonisolated public struct ProviderPreferences: Encodable, Sendable {
        ...
        /// When set to true, the request will only be routed to endpoints that have a Zero Data Retention policy.
        /// See: https://openrouter.ai/docs/guides/routing/provider-selection#zero-data-retention-enforcement
        public let zdr: Bool?

        /// Restrict routing to only models that allow text distillation.
        /// When set to true, the request will only be routed to models where the author has explicitly enabled text distillation.
        /// See: https://openrouter.ai/docs/guides/routing/provider-selection#distillable-text-enforcement
        public let enforceDistillableText: Bool?

        /// List of provider slugs to allow for this request.
        /// If provided, this list is merged with your account-wide allowed provider settings for this request.
